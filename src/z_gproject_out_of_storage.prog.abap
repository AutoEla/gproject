...
PARAMETERS:p_matnr1 TYPE zmatnr1,
           ...
           p_maadr  TYPE string,
           p_ouosd  TYPE dats DEFAULT sy-datum.
...
FORM fm_judge_matnr.
  ...
  IF sy-subrc = 0.
    ...
    UPDATE zgpstock SET volum = @lt_zgpstock-volum , ouosd = @p_ouosd WHERE zmatnr1 = @p_matnr1.
    IF sy-subrc = 0.
    ...
    ENDIF.
  ELSE.
    message '此商品不在库存中，请重试' TYPE 'I' DISPLAY LIKE 'E'.
  ENDIF.
...
FORM fm_get_device.
  ...
  CONSTANTS c_formname TYPE tdsfname VALUE 'ZF_GPROJECT_OUT_OF_STORAGE'.
